...
export default function AddNewCard({ addContent, currentDisplay, setCurrentDisplay }) {
  if (currentDisplay=="NEW_CARD_SCREEN") {
    ...
    return (
      <div className="bg-zinc-900/90 fixed z-[5] h-[80%] w-[80%] left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 rounded-2xl flex flex-col items-center justify-between p-2">
        ...
        <textarea
          className=" bg-transparent text-zinc-300 w-full p-4 h-[85%] border-none rounded-2xl text-2xl md:text-3xl"
          onChange={(e) => {
